  ...
  return (
    <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--text-primary)' }}>Physician Clinical EHR Dashboard</h1>
...
export const DoctorDashboardSubComponent1: React.FC<{ title?: string }> = ({ title = 'SubComponent 1' }) => (
...
export const DoctorDashboardSubComponent2: React.FC<{ title?: string }> = ({ title = 'SubComponent 2' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent3: React.FC<{ title?: string }> = ({ title = 'SubComponent 3' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent4: React.FC<{ title?: string }> = ({ title = 'SubComponent 4' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent5: React.FC<{ title?: string }> = ({ title = 'SubComponent 5' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent6: React.FC<{ title?: string }> = ({ title = 'SubComponent 6' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent7: React.FC<{ title?: string }> = ({ title = 'SubComponent 7' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent8: React.FC<{ title?: string }> = ({ title = 'SubComponent 8' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent9: React.FC<{ title?: string }> = ({ title = 'SubComponent 9' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent10: React.FC<{ title?: string }> = ({ title = 'SubComponent 10' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent11: React.FC<{ title?: string }> = ({ title = 'SubComponent 11' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent12: React.FC<{ title?: string }> = ({ title = 'SubComponent 12' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent13: React.FC<{ title?: string }> = ({ title = 'SubComponent 13' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent14: React.FC<{ title?: string }> = ({ title = 'SubComponent 14' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent15: React.FC<{ title?: string }> = ({ title = 'SubComponent 15' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent16: React.FC<{ title?: string }> = ({ title = 'SubComponent 16' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent17: React.FC<{ title?: string }> = ({ title = 'SubComponent 17' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent18: React.FC<{ title?: string }> = ({ title = 'SubComponent 18' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent19: React.FC<{ title?: string }> = ({ title = 'SubComponent 19' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent20: React.FC<{ title?: string }> = ({ title = 'SubComponent 20' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent21: React.FC<{ title?: string }> = ({ title = 'SubComponent 21' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent22: React.FC<{ title?: string }> = ({ title = 'SubComponent 22' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent23: React.FC<{ title?: string }> = ({ title = 'SubComponent 23' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent24: React.FC<{ title?: string }> = ({ title = 'SubComponent 24' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const DoctorDashboardSubComponent25: React.FC<{ title?: string }> = ({ title = 'SubComponent 25' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
