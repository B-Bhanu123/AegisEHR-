/**
 * AegisEHR Enterprise Health Platform - Clinical Workspace Sidebar
 */
  ...
  return (
    <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--text-primary)' }}>Clinical Workspace Sidebar</h1>
...
export const SidebarSubComponent1: React.FC<{ title?: string }> = ({ title = 'SubComponent 1' }) => (
...
export const SidebarSubComponent2: React.FC<{ title?: string }> = ({ title = 'SubComponent 2' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent3: React.FC<{ title?: string }> = ({ title = 'SubComponent 3' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent4: React.FC<{ title?: string }> = ({ title = 'SubComponent 4' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent5: React.FC<{ title?: string }> = ({ title = 'SubComponent 5' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent6: React.FC<{ title?: string }> = ({ title = 'SubComponent 6' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent7: React.FC<{ title?: string }> = ({ title = 'SubComponent 7' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent8: React.FC<{ title?: string }> = ({ title = 'SubComponent 8' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent9: React.FC<{ title?: string }> = ({ title = 'SubComponent 9' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent10: React.FC<{ title?: string }> = ({ title = 'SubComponent 10' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent11: React.FC<{ title?: string }> = ({ title = 'SubComponent 11' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent12: React.FC<{ title?: string }> = ({ title = 'SubComponent 12' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent13: React.FC<{ title?: string }> = ({ title = 'SubComponent 13' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent14: React.FC<{ title?: string }> = ({ title = 'SubComponent 14' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent15: React.FC<{ title?: string }> = ({ title = 'SubComponent 15' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent16: React.FC<{ title?: string }> = ({ title = 'SubComponent 16' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent17: React.FC<{ title?: string }> = ({ title = 'SubComponent 17' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent18: React.FC<{ title?: string }> = ({ title = 'SubComponent 18' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent19: React.FC<{ title?: string }> = ({ title = 'SubComponent 19' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent20: React.FC<{ title?: string }> = ({ title = 'SubComponent 20' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent21: React.FC<{ title?: string }> = ({ title = 'SubComponent 21' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent22: React.FC<{ title?: string }> = ({ title = 'SubComponent 22' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent23: React.FC<{ title?: string }> = ({ title = 'SubComponent 23' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent24: React.FC<{ title?: string }> = ({ title = 'SubComponent 24' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
...
export const SidebarSubComponent25: React.FC<{ title?: string }> = ({ title = 'SubComponent 25' }) => (
  <div className="glass-panel" style={{ padding: '1rem' }}>
    <h4 style={{ color: 'var(--text-primary)', marginBottom: '0.5rem' }}>{title}</h4>
